...
const I18N = {
    ja: {
        ...
        "create.anonWarning.message": "ログインしていない場合は、ルームは作成後24時間で削除されます。<br>※ ゲストのルーム作成は24時間に1回までとなります。",
        "create.anonWarning.ok": "OK",
        "create.anonWarning.cancel": "戻る",
        "create.limit.title": "⚠️ ルーム作成制限（24時間に1回）",
        "create.limit.message": "ゲスト（未ログイン）でのルーム作成は24時間に1回までとなっています。<br>続けてルームを作成・開催するには、無料アカウントへのログインまたは新規登録を行ってください。<br><br><span style='font-size:13px; color:#555;'>※ ログインすると、ルーム作成の回数制限がなくなり、作成したルームも保存されます。</span>",
        "create.limit.loginBtn": "ログイン / 新規登録へ",
        "create.limit.cancel": "閉じる",
        "create.limit.badgeNotice": "💡 ゲストは24時間に1回まで作成可能（ログインで無制限）",
        "create.limit.badgeCooldown": "⚠️ 本日のゲスト作成枠を使用済みです",
    ...
    en: {
        ...
        "create.anonWarning.message": "If you are not logged in, the room will be deleted 24 hours after creation.<br>※ Guests can create 1 room per 24 hours.",
        "create.anonWarning.ok": "OK",
        "create.anonWarning.cancel": "Back",
        "create.limit.title": "⚠️ Room Creation Limit (Once per 24 hours)",
        "create.limit.message": "Guest users can only create 1 room per 24 hours.<br>To create more rooms, please log in or sign up for a free account.<br><br><span style='font-size:13px; color:#555;'>※ Logged-in users have unlimited room creations and saved rooms.</span>",
        "create.limit.loginBtn": "Log In / Sign Up",
        "create.limit.cancel": "Close",
        "create.limit.badgeNotice": "💡 Guests can create 1 room per 24h (Unlimited with login)",
        "create.limit.badgeCooldown": "⚠️ Today's guest creation limit reached",
